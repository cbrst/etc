...
(deftheme dotshare
  "dotshare-theme, generated by polychrome")

(let ((class '((class color) (min-colors 89)))
	(dotshare-fg   "#D7D0C7")
	(dotshare-bg   "#151515")
	(dotshare-bg-1 "#0E0E0E")
	(dotshare-bg-2 "#1F1F1F")
	(dotshare-bg-3 "#5C5C5C")

	(dotshare-red       "#E84F4F")
	(dotshare-red+1     "#D13D3D")
			
	(dotshare-green     "#B7D58B")
	(dotshare-green+1   "#A0CF5E")

	(dotshare-yellow    "#E1A95B")
	(dotshare-yellow+1  "#F39B20")

	(dotshare-blue      "#7DC1CF")
	(dotshare-blue+1    "#4E9FB1")

	(dotshare-magenta   "#9C65FB")
	(dotshare-magenta+1 "#8442FF")

	(dotshare-cyan      "#6D878D")
	(dotshare-cyan+1    "#42707B"))
  ...
  (custom-theme-set-faces
   ...
   `(header-line ((,class (:foreground ,dotshare-yellow :background ,dotshare-bg-1
                           :box (:line-width 1 :color ,dotshare-bg-1)))))
   `(hl-line ((,class (:background ,dotshare-bg-2))))
   ...
   `(mode-line ((,class (:foreground ,dotshare-fg :background ,dotshare-bg-2
                         :box (:line-width 1 :color ,dotshare-bg-2)))))
   `(mode-line-inactive ((,class (:inherit mode-line :background ,dotshare-bg
                                  :box (:line-width 1 :color ,dotshare-bg)))))
   ...
   `(mode-line-folder-face ((,class (:foreground ,dotshare-bg-3))))
   `(mode-line-line-face ((,class (:foreground ,dotshare-magenta))))
   `(mode-line-minor-mode-face ((,class (:foreground ,dotshare-bg-3))))
   `(mode-line-mode-face ((,class (:foreground ,dotshare-yellow))))
   `(mode-line-modified-face ((,class (:foreground ,dotshare-magenta+1 :background ,dotshare-bg-2))))
   `(mode-line-read-only-face ((,class (:foreground ,dotshare-red))))
   `(mode-line-80col-face ((,class (:foreground ,dotshare-red))))

   `(region ((,class (:background ,dotshare-bg-3))))
   `(secondary-selection ((,class (:background ,dotshare-bg-3))))
   ...
   `(lazy-highlight ((,class (:foreground ,dotshare-yellow :background ,dotshare-bg-3))))

   ;; font-lock
   `(font-lock-builtin-face ((,class (:foreground ,dotshare-blue))))
   `(font-lock-comment-face ((,class (:foreground ,dotshare-bg-3))))
   `(font-lock-comment-delimiter-face ((,class (:foreground ,dotshare-bg-3))))
   ...
   ;; auto-complete
   `(ac-candidate-face ((,class (:background ,dotshare-bg-3 :foreground "white"))))
   ...
   `(diff-file-header
     ((,class (:background ,dotshare-bg-3 :foreground ,dotshare-fg :bold t))))
   ...
   `(gnus-group-news-6-empty-face ((,class (:foreground ,dotshare-bg-3))))
   `(gnus-group-news-low-empty-face ((,class (:foreground ,dotshare-bg-3))))
   `(gnus-signature-face ((,class (:foreground ,dotshare-yellow))))
   `(gnus-x-face ((,class (:background ,dotshare-fg :foreground ,dotshare-bg))))

   ;; ido
   `(ido-only-match-face ((,class (:foreground ,dotshare-green))))
   `(ido-subdir-face ((,class (:foreground ,dotshare-red))))

   ;; JS2
   `(js2-error-face ((,class (:foreground ,dotshare-red))))
   `(js2-external-variable-face ((,class (:foreground ,dotshare-magenta+1))))
   `(js2-function-param-face ((,class (:foreground ,dotshare-green))))
   `(js2-instance-member-face ((,class (:foreground ,dotshare-green+1))))
   `(js2-jsdoc-html-tag-delimiter-face ((,class (:foreground ,dotshare-green))))
   `(js2-jsdoc-html-tag-name-face ((,class (:foreground ,dotshare-yellow))))
   `(js2-jsdoc-tag-face ((,class (:foreground ,dotshare-bg-3))))
   `(js2-jsdoc-type-face ((,class (:foreground ,dotshare-bg-2))))
   `(js2-jsdoc-value-face ((,class (:foreground ,dotshare-bg-2))))
   `(js2-private-function-call-face ((,class (:foreground ,dotshare-yellow))))
   `(js2-private-member-face ((,class (:foreground ,dotshare-cyan+1))))
   `(js2-warning-face ((,class (:underline (:color ,dotshare-bg-3 :style wave)))))

   ;; JS3
   `(js3-error-face ((,class (:foreground ,dotshare-red))))
   `(js3-external-variable-face ((,class (:foreground ,dotshare-magenta+1))))
   `(js3-function-param-face ((,class (:foreground ,dotshare-green))))
   `(js3-instance-member-face ((,class (:foreground ,dotshare-green+1))))
   `(js3-jsdoc-html-tag-delimiter-face ((,class (:foreground ,dotshare-green))))
   `(js3-jsdoc-html-tag-name-face ((,class (:foreground ,dotshare-yellow))))
   `(js3-jsdoc-tag-face ((,class (:foreground ,dotshare-bg-3))))
   `(js3-jsdoc-type-face ((,class (:foreground ,dotshare-bg-2))))
   `(js3-jsdoc-value-face ((,class (:foreground ,dotshare-bg-2))))
   `(js3-private-function-call-face ((,class (:foreground ,dotshare-yellow))))
   `(js3-private-member-face ((,class (:foreground ,dotshare-cyan+1))))
   `(js3-warning-face ((,class (:underline (:color ,dotshare-bg-3 :style wave)))))
   ...
   ;; mmm
   `(mmm-code-submode-face ((,class (:background ,dotshare-bg-1))))
   ...
   `(org-checkbox ((,class (:background ,dotshare-bg-3 :foreground "white"
:box (:line-width 1 :style released-button)))))
   ...
   `(post-header-keyword-face ((,class (:foreground ,dotshare-bg-2))))
   ...
   `(post-signature-text-face ((,class (:foreground ,dotshare-bg-3))))
   ...
   `(speedbar-highlight-face ((,class (:background ,dotshare-bg-3))))
   `(speedbar-selected-face ((,class (:background ,dotshare-bg-2))))
   `(speedbar-separator-face ((,class (:foreground ,dotshare-bg-2))))
