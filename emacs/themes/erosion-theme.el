...
(let ((class '((class color) (min-colors 89)))
      ...
      (erosion-red       "#9B5E3B")
      (erosion-red+1     "#B16E43")

      (erosion-green     "#D2C984")
      (erosion-green+1   "#CDD26A")

      (erosion-yellow    "#CAC286")
      (erosion-yellow+1  "#FFFFB4")

      (erosion-blue      "#626B6F")
      (erosion-blue+1    "#5E6F78")

      (erosion-magenta   "#6E6774")
      (erosion-magenta+1 "#756D7E")

      (erosion-cyan      "#374A4D")
      (erosion-cyan+1    "#425052"))
  ...
  (defface mode-line-line
    '((t :foreground "violet")) "Custom Face")
  ...
  (custom-theme-set-faces
   ...
   `(header-line ((,class (:foreground ,erosion-yellow :background ,erosion-bg-1
                                       :box (:line-width 1 :color ,erosion-bg-1)))))
   `(hl-line ((,class (:background ,erosion-bg-2))))
   ...
   `(mode-line
     ((,class (:foreground ,erosion-fg :background ,erosion-bg-2
                           :box (:line-width 1 :color ,erosion-bg-2)))))
   `(mode-line-inactive
     ((,class (:inherit mode-line :background ,erosion-bg-1
                        :box (:line-width 1 :color ,erosion-bg-1)))))
   `(mode-line-buffer-id
     ((,class (:inherit 'erosion-yellow :weight bold))))
   `(mode-line-buffer-name
     ((,class (:foreground ,erosion-cyan :weight bold))))
   `(mode-line-col
     ((,class (:foreground ,erosion-green+1))))
   `(mode-line-folder
     ((,class (:foreground ,erosion-bg-3))))
   `(mode-line-line
     ((,class (:foreground ,erosion-magenta))))
   `(mode-line-minor-mode
     ((,class (:foreground ,erosion-bg-3))))
   `(mode-line-mode
     ((,class (:foreground ,erosion-yellow+1))))
   `(mode-line-modified
     ((,class (:foreground ,erosion-magenta+1 :background ,erosion-bg-2))))
   `(mode-line-read-only
     ((,class (:foreground ,erosion-red))))
   `(mode-line-80col
     ((,class (:foreground ,erosion-red))))
   `(mode-line-func
     ((,class (:foreground ,erosion-blue))))

   `(region ((,class (:background ,erosion-bg-3))))
   `(secondary-selection ((,class (:background ,erosion-bg-3))))
   ...
   `(isearch-fail ((,class (:foreground ,erosion-fg :background ,erosion-red))))
   `(lazy-highlight ((,class (:foreground ,erosion-yellow :background ,erosion-bg-3))))

   ;; font-lock
   `(font-lock-builtin-face ((,class (:foreground ,erosion-blue))))
   `(font-lock-comment-face ((,class (:foreground ,erosion-bg-3))))
   `(font-lock-comment-delimiter-face ((,class (:foreground ,erosion-bg-3))))
   ...
   `(font-lock-string-face ((,class (:foreground ,erosion-magenta))))
   `(font-lock-type-face ((,class (:foregorund ,erosion-yellow))))
   `(font-lock-variable-name-face ((,class (:foreground ,erosion-yellow))))
   `(font-lock-warning-face ((,class (:foreground ,erosion-yellow :weight bold :underline t))))
   `(font-lock-pseudo-keyword-face ((,class (:foreground ,erosion-yellow))))
   `(font-lock-operator-face ((,class (:foreground ,erosion-magenta+1))))
   ...
   ;; auto-complete
   `(ac-candidate-face ((,class (:background ,erosion-bg-3 :foreground "white"))))
   `(ac-selection-face ((,class (:background ,erosion-blue+1 :foreground ,erosion-fg))))
   `(popup-tip-face ((,class (:background ,erosion-yellow :foreground "black"))))
   ...
   ;; diff
   `(diff-added ((,class (:foreground ,erosion-green+1))))
   `(diff-changed ((,class (:foreground ,erosion-yellow))))
   `(diff-removed ((,class (:foreground ,erosion-red))))
   `(diff-header ((,class (:background ,erosion-bg-2))))
   `(diff-file-header
     ((,class (:background ,erosion-bg-3 :foreground ,erosion-fg :bold t))))

   ;; eshell
   `(eshell-prompt ((,class (:foreground ,erosion-yellow :weight bold))))
   `(eshell-ls-archive ((,class (:foreground ,erosion-red :weight bold))))
   ...
   `(erc-pal-face ((,class (:foreground ,erosion-magenta+1 :weight bold))))
   `(erc-prompt-face ((,class (:foreground ,erosion-magenta+1 :weight bold))))
   ...
   ;; flymake
   `(flymake-errline ((,class (:foreground ,erosion-red :weight bold :underline t))))
   `(flymake-warnline ((,class (:foreground ,erosion-yellow :weight bold :underline t))))

   ;; flyspell
   `(flyspell-duplicate ((,class (:foreground ,erosion-yellow :weight bold :underline t))))
   `(flyspell-incorrect ((,class (:foreground ,erosion-red :weight bold :underline t))))
   ...
   `(gnus-summary-cancelled-face ((,class (:foreground ,erosion-magenta+1))))
   ...
   `(gnus-summary-high-ticked-face ((,class (:foreground ,erosion-magenta+1 :weight bold))))
   ...
   `(gnus-summary-low-ticked-face ((,class (:foreground ,erosion-magenta+1 :weight bold))))
   ...
   `(gnus-summary-normal-ticked-face ((,class (:foreground ,erosion-magenta+1 :weight bold))))
   ...
   `(gnus-cite-10-face ((,class (:foreground ,erosion-yellow))))
   `(gnus-cite-11-face ((,class (:foreground ,erosion-yellow))))
   `(gnus-cite-2-face ((,class (:foreground ,erosion-cyan+1))))
   `(gnus-cite-3-face ((,class (:foreground ,erosion-blue))))
   `(gnus-cite-4-face ((,class (:foreground ,erosion-green+1))))
   ...
   `(gnus-cite-8-face ((,class (:foreground ,erosion-red))))
   `(gnus-cite-9-face ((,class (:foreground ,erosion-red))))
   `(gnus-group-news-1-empty-face ((,class (:foreground ,erosion-yellow))))
   `(gnus-group-news-2-empty-face ((,class (:foreground ,erosion-green+1))))
   `(gnus-group-news-3-empty-face ((,class (:foreground ,erosion-green+1))))
   `(gnus-group-news-4-empty-face ((,class (:foreground ,erosion-blue))))
   `(gnus-group-news-5-empty-face ((,class (:foreground ,erosion-blue))))
   `(gnus-group-news-6-empty-face ((,class (:foreground ,erosion-bg-3))))
   `(gnus-group-news-low-empty-face ((,class (:foreground ,erosion-bg-3))))
   `(gnus-signature-face ((,class (:foreground ,erosion-yellow))))
   `(gnus-x-face ((,class (:background ,erosion-fg :foreground ,erosion-bg))))

   ;; JS2
   `(js2-error-face ((,class (:foreground ,erosion-red))))
   `(js2-external-variable-face ((,class (:foreground ,erosion-magenta+1))))
   `(js2-function-param-face ((,class (:foreground ,erosion-green))))
   `(js2-instance-member-face ((,class (:foreground ,erosion-green+1))))
   `(js2-jsdoc-html-tag-delimiter-face ((,class (:foreground ,erosion-green))))
   `(js2-jsdoc-html-tag-name-face ((,class (:foreground ,erosion-yellow))))
   `(js2-jsdoc-tag-face ((,class (:foreground ,erosion-bg-3))))
   `(js2-jsdoc-type-face ((,class (:foreground ,erosion-bg-2))))
   `(js2-jsdoc-value-face ((,class (:foreground ,erosion-bg-2))))
   `(js2-private-function-call-face ((,class (:foreground ,erosion-yellow))))
   `(js2-private-member-face ((,class (:foreground ,erosion-cyan+1))))
   `(js2-warning-face ((,class (:underline (:color ,erosion-bg-3 :style wave)))))

   ;; JS3
   `(js3-error-face ((,class (:foreground ,erosion-red))))
   `(js3-external-variable-face ((,class (:foreground ,erosion-magenta+1))))
   `(js3-function-param-face ((,class (:foreground ,erosion-green))))
   `(js3-instance-member-face ((,class (:foreground ,erosion-green+1))))
   `(js3-jsdoc-html-tag-delimiter-face ((,class (:foreground ,erosion-green))))
   `(js3-jsdoc-html-tag-name-face ((,class (:foreground ,erosion-yellow))))
   `(js3-jsdoc-tag-face ((,class (:foreground ,erosion-bg-3))))
   `(js3-jsdoc-type-face ((,class (:foreground ,erosion-bg-2))))
   `(js3-jsdoc-value-face ((,class (:foreground ,erosion-bg-2))))
   `(js3-private-function-call-face ((,class (:foreground ,erosion-yellow))))
   `(js3-private-member-face ((,class (:foreground ,erosion-cyan+1))))
   `(js3-warning-face ((,class (:underline (:color ,erosion-bg-3 :style wave)))))

   ;; magit
   `(magit-section-title ((,class (:foreground ,erosion-yellow :weight bold))))
   `(magit-branch ((,class (:foreground ,erosion-magenta+1 :weight bold))))
   ...
   `(message-header-subject-face ((,class (:inherit 'erosion-magenta+1 :weight bold))))
   ...
   ;; mew
   `(mew-face-header-subject ((,class (:foreground ,erosion-magenta+1))))
   ...
   `(mew-face-body-url ((,class (:foreground ,erosion-magenta+1))))
   ...
   `(mew-face-body-cite3 ((,class (:foreground ,erosion-magenta+1))))
   ...
   `(mew-face-mark-unread ((,class (:foreground ,erosion-red))))
   ...
   `(nav-face-hfile ((,class (:foreground ,erosion-red))))
   ...
   `(org-checkbox ((,class (:background ,erosion-bg-3 :foreground "white"
                                        :box (:line-width 1 :style released-button)))))
   `(org-date ((,class (:foreground ,erosion-blue :underline t))))
   `(org-deadline-announce ((,class (:foreground ,erosion-red))))
   `(org-done ((,class (:bold t :weight bold :foreground ,erosion-green+1))))
   `(org-formula ((,class (:foreground ,erosion-yellow))))
   `(org-headline-done ((,class (:foreground ,erosion-green+1))))
   `(org-hide ((,class (:foreground ,erosion-bg-1))))
   `(org-level-1 ((,class (:foreground ,erosion-magenta+1))))
   `(org-level-2 ((,class (:foreground ,erosion-green+1))))
   `(org-level-3 ((,class (:foreground ,erosion-cyan+1))))
   `(org-level-4 ((,class (:foreground ,erosion-yellow))))
   `(org-level-5 ((,class (:foreground ,erosion-cyan))))
   `(org-level-6 ((,class (:foreground ,erosion-green))))
   `(org-level-7 ((,class (:foreground ,erosion-red))))
   `(org-level-8 ((,class (:foreground ,erosion-blue+1))))
   `(org-link ((,class (:foreground ,erosion-yellow :underline t))))
   `(org-scheduled ((,class (:foreground ,erosion-green+1))))
   `(org-scheduled-previously ((,class (:foreground ,erosion-red))))
   `(org-scheduled-today ((,class (:foreground ,erosion-blue+1))))
   `(org-special-keyword ((,class (:foreground ,erosion-yellow))))
   `(org-table ((,class (:foreground ,erosion-green+1))))
   `(org-tag ((,class (:bold t :weight bold))))
   `(org-time-grid ((,class (:foreground ,erosion-magenta+1))))
   ...
   `(post-emoticon-face ((,class (:foreground ,erosion-green+1 :weight bold))))
   `(post-header-keyword-face ((,class (:foreground ,erosion-bg-2))))
   `(post-header-value-face ((,class (:foreground ,erosion-fg))))
   `(post-multiply-quoted-text-face ((,class (:foreground ,erosion-magenta+1))))
   `(post-quoted-text-face ((,class (:foreground ,erosion-yellow))))
   `(post-signature-text-face ((,class (:foreground ,erosion-bg-3))))
   `(post-underline-face ((,class (:foreground ,erosion-green))))
   `(post-url-face ((,class (:foreground ,erosion-blue :underline t))))
   ...
   `(rainbow-delimiters-depth-6-face ((,class (:foreground ,erosion-cyan+1 :weight bold))))
   `(rainbow-delimiters-depth-7-face ((,class (:foreground ,erosion-green+1 :weight bold))))
   `(rainbow-delimiters-depth-8-face ((,class (:foreground ,erosion-red :weight bold))))
   `(rainbow-delimiters-depth-9-face ((,class (:foreground ,erosion-yellow :weight bold))))
   `(rainbow-delimiters-depth-10-face ((,class (:foreground ,erosion-green+1 :weight bold))))
   `(rainbow-delimiters-depth-11-face ((,class (:foreground ,erosion-blue+1 :weight bold))))
   `(rainbow-delimiters-depth-12-face ((,class (:foreground ,erosion-red :weight bold))))
   ...
   `(speedbar-highlight-face ((,class (:background ,erosion-bg-3))))
   `(speedbar-selected-face ((,class (:background ,erosion-bg-2))))
   `(speedbar-separator-face ((,class (:foreground ,erosion-bg-2))))
   `(speedbar-tag-face ((,class (:foreground ,erosion-yellow))))

   ;; wl (wanderlust)
   ;; some faces end with -face, while other don't; confusing
   `(wl-highlight-folder-few-face ((,class (:foreground ,erosion-red))))
   `(wl-highlight-folder-many-face ((,class (:foreground ,erosion-red))))
   `(wl-highlight-folder-path-face ((,class (:foreground ,erosion-magenta+1))))
   ...
   `(wl-highlight-message-citation-header ((,class (:foreground ,erosion-red))))
   `(wl-highlight-message-cited-text-1 ((,class (:foreground ,erosion-red))))
   `(wl-highlight-message-cited-text-2 ((,class (:foreground ,erosion-green+1))))
   ...
   `(wl-highlight-message-important-header-contents ((,class (:foreground ,erosion-green+1))))
   `(wl-highlight-message-header-contents ((,class (:foreground ,erosion-green+1))))
   `(wl-highlight-message-important-header-contents2 ((,class (:foreground ,erosion-green+1))))
   ...
   `(wl-highlight-summary-answeredace ((,class (:foreground ,erosion-blue))))
