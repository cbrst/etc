...
zstyle ':vcs_info:git:*' formats         "%F{9}(%s:%F{7}%B%r%F{9}) ${FMT_BRANCH} %u%c"
zstyle ':vcs_info:hg:*'  formats         "%F{13}(%s:%F{7}%B%r%F{13}) ${FMT_BRANCH} %u%c"
zstyle ':vcs_info:svn:*' formats         "%F{14}(%s:%F{7}%B%r%F{14}) ${FMT_BRANCH} %u%c"

zstyle ':vcs_info:git:*' actionformats   "%F{9}(%s:%F{7}%B%r%F{9}) ${FMT_BRANCH} %u%c ${FMT_ACTION}"
zstyle ':vcs_info:hg:*'  actionformats   "%F{13}(%s:%F{7}%B%r%F{13}) ${FMT_BRANCH} %u%c ${FMT_ACTION}"
zstyle ':vcs_info:svn:*' actionformats   "%F{14}(%s:%F{7}%B%r%F{14}) ${FMT_BRANCH} %u%c ${FMT_ACTION}"
