...
(let ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   ...
   `(mode-line ((,class (:foreground ,erosion-fg :background ,erosion-bg-2
                         :box (:line-width 1 :color ,erosion-bg-2)))))
   `(mode-line-inactive ((,class (:inherit mode-line :background ,erosion-bg
                                  :box (:line-width 1 :color ,erosion-bg)))))
   ...
   `(mode-line-col-face ((,class (:foreground ,erosion-green+1))))
   `(mode-line-folder-face ((,class (:foreground ,erosion-bg-3))))
   `(mode-line-line-face ((,class (:foreground ,erosion-magenta))))
   `(mode-line-minor-mode-face ((,class (:foreground ,erosion-bg-3))))
   `(mode-line-mode-face ((,class (:foreground ,erosion-yellow))))
   `(mode-line-modified-face ((,class (:foreground ,erosion-magenta+1 :background ,erosion-bg-2))))
   `(mode-line-read-only-face ((,class (:foreground ,erosion-red))))
   `(mode-line-80col-face ((,class (:foreground ,erosion-red))))
