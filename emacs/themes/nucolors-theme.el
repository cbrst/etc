...
(deftheme nucolors
  "nucolors-theme, generated by polychrome")

(let ((class '((class color) (min-colors 89)))
	(nucolors-fg   "#C7C7C7")
	(nucolors-bg   "#151515")
	(nucolors-bg-1 "#0E0E0E")
	(nucolors-bg-2 "#1F1F1F")
	(nucolors-bg-3 "#5C5C5C")

	(nucolors-red       "#FF9F94")
	(nucolors-red+1     "#FF8C80")
			
	(nucolors-green     "#E2FFC7")
	(nucolors-green+1   "#DBFFB3")

	(nucolors-yellow    "#FFFFB8")
	(nucolors-yellow+1  "#FFBF66")

	(nucolors-blue      "#A9CFEA")
	(nucolors-blue+1    "#80B7FF")

	(nucolors-magenta   "#E2B6CD")
	(nucolors-magenta+1 "#E194FF")

	(nucolors-cyan      "#C2EFFF")
	(nucolors-cyan+1    "#9EEAFF"))
  ...
  (custom-theme-set-faces
   ...
   `(header-line ((,class (:foreground ,nucolors-yellow :background ,nucolors-bg-1
                           :box (:line-width 1 :color ,nucolors-bg-1)))))
   `(hl-line ((,class (:background ,nucolors-bg-2))))
   ...
   `(mode-line ((,class (:foreground ,nucolors-fg :background ,nucolors-bg-2
                         :box (:line-width 1 :color ,nucolors-bg-2)))))
   `(mode-line-inactive ((,class (:inherit mode-line :background ,nucolors-bg
                                  :box (:line-width 1 :color ,nucolors-bg)))))
   ...
   `(mode-line-folder-face ((,class (:foreground ,nucolors-bg-3))))
   `(mode-line-line-face ((,class (:foreground ,nucolors-magenta))))
   `(mode-line-minor-mode-face ((,class (:foreground ,nucolors-bg-3))))
   `(mode-line-mode-face ((,class (:foreground ,nucolors-yellow))))
   `(mode-line-modified-face ((,class (:foreground ,nucolors-magenta+1 :background ,nucolors-bg-2))))
   `(mode-line-read-only-face ((,class (:foreground ,nucolors-red))))
   `(mode-line-80col-face ((,class (:foreground ,nucolors-red))))

   `(region ((,class (:background ,nucolors-bg-3))))
   `(secondary-selection ((,class (:background ,nucolors-bg-3))))
   ...
   `(isearch-fail ((,class (:foreground ,nucolors-fg :background ,nucolors-red))))
   `(lazy-highlight ((,class (:foreground ,nucolors-yellow :background ,nucolors-bg-3))))

   ;; font-lock
   `(font-lock-builtin-face ((,class (:foreground ,nucolors-blue))))
   `(font-lock-comment-face ((,class (:foreground ,nucolors-bg-3))))
   `(font-lock-comment-delimiter-face ((,class (:foreground ,nucolors-bg-3))))
   ...
   `(font-lock-string-face ((,class (:foreground ,nucolors-magenta))))
   `(font-lock-type-face ((,class (:foregorund ,nucolors-yellow))))
   `(font-lock-variable-name-face ((,class (:foreground ,nucolors-yellow))))
   `(font-lock-warning-face ((,class (:foreground ,nucolors-yellow :weight bold :underline t))))
   ...
   ;; auto-complete
   `(ac-candidate-face ((,class (:background ,nucolors-bg-3 :foreground "white"))))
   `(ac-selection-face ((,class (:background ,nucolors-blue+1 :foreground ,nucolors-fg))))
   `(popup-tip-face ((,class (:background ,nucolors-yellow :foreground "black"))))
   ...
   ;; diff
   `(diff-added ((,class (:foreground ,nucolors-green+1))))
   `(diff-changed ((,class (:foreground ,nucolors-yellow))))
   `(diff-removed ((,class (:foreground ,nucolors-red))))
   `(diff-header ((,class (:background ,nucolors-bg-2))))
   `(diff-file-header
     ((,class (:background ,nucolors-bg-3 :foreground ,nucolors-fg :bold t))))

   ;; eshell
   `(eshell-prompt ((,class (:foreground ,nucolors-yellow :weight bold))))
   `(eshell-ls-archive ((,class (:foreground ,nucolors-red :weight bold))))
   ...
   ;; flymake
   `(flymake-errline ((,class (:foreground ,nucolors-red :weight bold :underline t))))
   `(flymake-warnline ((,class (:foreground ,nucolors-yellow :weight bold :underline t))))

   ;; flyspell
   `(flyspell-duplicate ((,class (:foreground ,nucolors-yellow :weight bold :underline t))))
   `(flyspell-incorrect ((,class (:foreground ,nucolors-red :weight bold :underline t))))
   ...
   `(gnus-cite-10-face ((,class (:foreground ,nucolors-yellow))))
   `(gnus-cite-11-face ((,class (:foreground ,nucolors-yellow))))
   `(gnus-cite-2-face ((,class (:foreground ,nucolors-cyan+1))))
   `(gnus-cite-3-face ((,class (:foreground ,nucolors-blue))))
   `(gnus-cite-4-face ((,class (:foreground ,nucolors-green+1))))
   ...
   `(gnus-cite-8-face ((,class (:foreground ,nucolors-red))))
   `(gnus-cite-9-face ((,class (:foreground ,nucolors-red))))
   `(gnus-group-news-1-empty-face ((,class (:foreground ,nucolors-yellow))))
   `(gnus-group-news-2-empty-face ((,class (:foreground ,nucolors-green+1))))
   `(gnus-group-news-3-empty-face ((,class (:foreground ,nucolors-green+1))))
   `(gnus-group-news-4-empty-face ((,class (:foreground ,nucolors-blue))))
   `(gnus-group-news-5-empty-face ((,class (:foreground ,nucolors-blue))))
   `(gnus-group-news-6-empty-face ((,class (:foreground ,nucolors-bg-3))))
   `(gnus-group-news-low-empty-face ((,class (:foreground ,nucolors-bg-3))))
   `(gnus-signature-face ((,class (:foreground ,nucolors-yellow))))
   `(gnus-x-face ((,class (:background ,nucolors-fg :foreground ,nucolors-bg))))

   ;; ido
   `(ido-only-match-face ((,class (:foreground ,nucolors-green))))
   `(ido-subdir-face ((,class (:foreground ,nucolors-red))))

   ;; JS2
   `(js2-error-face ((,class (:foreground ,nucolors-red))))
   `(js2-external-variable-face ((,class (:foreground ,nucolors-magenta+1))))
   `(js2-function-param-face ((,class (:foreground ,nucolors-green))))
   `(js2-instance-member-face ((,class (:foreground ,nucolors-green+1))))
   `(js2-jsdoc-html-tag-delimiter-face ((,class (:foreground ,nucolors-green))))
   `(js2-jsdoc-html-tag-name-face ((,class (:foreground ,nucolors-yellow))))
   `(js2-jsdoc-tag-face ((,class (:foreground ,nucolors-bg-3))))
   `(js2-jsdoc-type-face ((,class (:foreground ,nucolors-bg-2))))
   `(js2-jsdoc-value-face ((,class (:foreground ,nucolors-bg-2))))
   `(js2-private-function-call-face ((,class (:foreground ,nucolors-yellow))))
   `(js2-private-member-face ((,class (:foreground ,nucolors-cyan+1))))
   `(js2-warning-face ((,class (:underline (:color ,nucolors-bg-3 :style wave)))))

   ;; JS3
   `(js3-error-face ((,class (:foreground ,nucolors-red))))
   `(js3-external-variable-face ((,class (:foreground ,nucolors-magenta+1))))
   `(js3-function-param-face ((,class (:foreground ,nucolors-green))))
   `(js3-instance-member-face ((,class (:foreground ,nucolors-green+1))))
   `(js3-jsdoc-html-tag-delimiter-face ((,class (:foreground ,nucolors-green))))
   `(js3-jsdoc-html-tag-name-face ((,class (:foreground ,nucolors-yellow))))
   `(js3-jsdoc-tag-face ((,class (:foreground ,nucolors-bg-3))))
   `(js3-jsdoc-type-face ((,class (:foreground ,nucolors-bg-2))))
   `(js3-jsdoc-value-face ((,class (:foreground ,nucolors-bg-2))))
   `(js3-private-function-call-face ((,class (:foreground ,nucolors-yellow))))
   `(js3-private-member-face ((,class (:foreground ,nucolors-cyan+1))))
   `(js3-warning-face ((,class (:underline (:color ,nucolors-bg-3 :style wave)))))
   ...
   `(mew-face-mark-unread ((,class (:foreground ,nucolors-red))))
   `(mew-face-eof-message ((,class (:foreground ,nucolors-green))))
   `(mew-face-eof-part ((,class (:foreground ,nucolors-yellow))))

   ;; mmm
   `(mmm-code-submode-face ((,class (:background ,nucolors-bg-1))))
   ...
   `(nav-face-hfile ((,class (:foreground ,nucolors-red))))
   ...
   `(org-checkbox ((,class (:background ,nucolors-bg-3 :foreground "white"
:box (:line-width 1 :style released-button)))))
   `(org-date ((,class (:foreground ,nucolors-blue :underline t))))
   `(org-deadline-announce ((,class (:foreground ,nucolors-red))))
   `(org-done ((,class (:bold t :weight bold :foreground ,nucolors-green+1))))
   `(org-formula ((,class (:foreground ,nucolors-yellow))))
   `(org-headline-done ((,class (:foreground ,nucolors-green+1))))
   ...
   `(org-level-4 ((,class (:foreground ,nucolors-yellow))))
   `(org-level-5 ((,class (:foreground ,nucolors-cyan))))
   `(org-level-6 ((,class (:foreground ,nucolors-green))))
   `(org-level-7 ((,class (:foreground ,nucolors-red))))
   `(org-level-8 ((,class (:foreground ,nucolors-blue+1))))
   `(org-link ((,class (:foreground ,nucolors-yellow :underline t))))
   `(org-scheduled ((,class (:foreground ,nucolors-green+1))))
   `(org-scheduled-previously ((,class (:foreground ,nucolors-red))))
   `(org-scheduled-today ((,class (:foreground ,nucolors-blue+1))))
   `(org-special-keyword ((,class (:foreground ,nucolors-yellow))))
   `(org-table ((,class (:foreground ,nucolors-green+1))))
   ...
   `(post-emoticon-face ((,class (:foreground ,nucolors-green+1 :weight bold))))
   `(post-header-keyword-face ((,class (:foreground ,nucolors-bg-2))))
   ...
   `(post-signature-text-face ((,class (:foreground ,nucolors-bg-3))))
   `(post-underline-face ((,class (:foreground ,nucolors-green))))
   `(post-url-face ((,class (:foreground ,nucolors-blue :underline t))))
   ...
   `(rainbow-delimiters-depth-7-face ((,class (:foreground ,nucolors-green+1 :weight bold))))
   `(rainbow-delimiters-depth-8-face ((,class (:foreground ,nucolors-red :weight bold))))
   `(rainbow-delimiters-depth-9-face ((,class (:foreground ,nucolors-yellow :weight bold))))
   `(rainbow-delimiters-depth-10-face ((,class (:foreground ,nucolors-green+1 :weight bold))))
   `(rainbow-delimiters-depth-11-face ((,class (:foreground ,nucolors-blue+1 :weight bold))))
   `(rainbow-delimiters-depth-12-face ((,class (:foreground ,nucolors-red :weight bold))))
   ...
   `(speedbar-highlight-face ((,class (:background ,nucolors-bg-3))))
   `(speedbar-selected-face ((,class (:background ,nucolors-bg-2))))
   `(speedbar-separator-face ((,class (:foreground ,nucolors-bg-2))))
   `(speedbar-tag-face ((,class (:foreground ,nucolors-yellow))))

   ;; wl (wanderlust)
   ;; some faces end with -face, while other don't; confusing
   `(wl-highlight-folder-few-face ((,class (:foreground ,nucolors-red))))
   `(wl-highlight-folder-many-face ((,class (:foreground ,nucolors-red))))
   ...
   `(wl-highlight-message-citation-header ((,class (:foreground ,nucolors-red))))
   `(wl-highlight-message-cited-text-1 ((,class (:foreground ,nucolors-red))))
   `(wl-highlight-message-cited-text-2 ((,class (:foreground ,nucolors-green+1))))
   ...
   `(wl-highlight-message-important-header-contents ((,class (:foreground ,nucolors-green+1))))
   `(wl-highlight-message-header-contents ((,class (:foreground ,nucolors-green+1))))
   `(wl-highlight-message-important-header-contents2 ((,class (:foreground ,nucolors-green+1))))
   ...
   `(wl-highlight-summary-answeredace ((,class (:foreground ,nucolors-blue))))
